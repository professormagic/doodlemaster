...
public class MegaJumper extends ApplicationAdapter {
    ...
    @Override
    public void create () {
        death = Gdx.audio.newMusic(Gdx.files.internal("Spongebob Porno.mp3"));
        doodleboii = new Texture("doodleboii.png");
    ...
    private void drawGame() {
        ...
        batch.begin();
        batch.draw(doodleboii,camera.position.x-width/2,camera .position.y-height / 2 ,width,height);
        ...
        if (state == GameState.START) {
            ...
            font.draw(batch, "Score: " + score, width / 2 - font.getBounds("Score: "+ score).width / 2, Gdx.graphics.getHeight() / 5 + font.getBounds("S").height + 10);
